...
!function(t, e) {
    ...
    function Ri(t, e, i) {
        ...
        for (let t = c, i = c; t <= d; ++t)
            m = e[t % a],
            m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ei({
                start: _,
                end: t,
                loop: u,
                count: a,
    ...
    class Js extends Hs {
        ...
        calculateLabelRotation()
        {
            ...
            c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Ks(t.grid) - e.padding - Gs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = Y(Math.min(Math.asin(J((h.highest.height + 6) / o, -1, 1)), Math.asin(J(a / r, -1, 1)) - Math.asin(J(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))),
    ...
    function Vn(t, e, i, s) {
        ...
        "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Bn(c, a, r, l)] = !0, n = h)),
        o[Bn(n, a, r, l)] = !0,
        t.borderSkipped = o
    }
    function Bn(t, e, i, s) {
    ...
    var $n = Object.freeze({
        ...
        LineController: class  extends Ns{
            ...
            update(t)
            {
                ...
                i.points = s.slice(Math.max(this._drawStart - 1, 0), this._drawStart + this._drawCount);
    ...
    class mo extends Js {
        ...
        buildTicks()
        {
            ...
            const n = function(t, e) {
                ...
                b && x && o && H((r - a) / o, S / 1e3) ? (k = Math.round(Math.min((r - a) / S, c)), S = (r - a) / k, M = a, w = r) : _ ? (M = b ? a : M, w = x ? r : w, k = h - 1, S = (w - M) / k) : (k = (w - M) / S, k = V(k, Math.round(k), S / 1e3) ? Math.round(k) : Math.ceil(k));
